...
public class AppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int x = 0; x < 5; x++) {
            hospitals.add(new Hospital("Hospital " + x, "Address " + x));
        }
        ...
        ArrayAdapter<Hospital> adapter = new ArrayAdapter<Hospital>(this, android.R.layout.simple_spinner_item, hospitals);
